...
from gsv.Synthesizers.base import Base_TTS_Synthesizer, Base_TTS_Task, get_wave_header_chunk
...
# 设置国际化支持
i18n = i18n_module.I18nAuto(language=app_config.locale, locale_path=f"src/gsv/Synthesizers/{synthesizer_name}/configs/i18n/locale")
