...
from gsv.GPT_SoVITS.AR.models.t2s_lightning_module import Text2SemanticLightningModule
from gsv.GPT_SoVITS.feature_extractor.cnhubert import CNHubert
from gsv.GPT_SoVITS.module.models import SynthesizerTrn
import librosa
from time import time as ttime
from gsv.tools.i18n.i18n import I18nAuto
from gsv.GPT_SoVITS.my_utils import load_audio
...
class TTS:
    ...
    def init_vits_weights(self, weights_path: str):
        ...
        import sys
        import gsv.GPT_SoVITS.utils as utils
        sys.modules['utils'] = utils  # 修复过时的模块引用 # TODO XnneHang 这可能存在覆盖的风险。
